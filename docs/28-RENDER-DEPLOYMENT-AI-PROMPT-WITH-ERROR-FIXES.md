...
```
mongodb+srv://username:password@cluster.mongodb.net/business-ai?retryWrites=true&w=majority&ssl=true&tls=true
```
...
```
1. MONGODB_URI
   Value: mongodb+srv://username:password@cluster.mongodb.net/business-ai?retryWrites=true&w=majority&ssl=true&tls=true
